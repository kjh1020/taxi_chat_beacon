...
public class DeviceScanActivity extends Activity {
    ...
    private HashSet<String> ble_list; // 스캔되는 Ble 기기들을 담는 리스트
    private ArrayList<Beacon> ble_white_list; // 스캔되는 Ble 기기들을 비교할 화이트리스트
    private String phone_id; //폰 아이디값을 저장
    ...
    /**
     * ble ddvice 들을 스캔하는 기능 구현
     * onLeScan메소드가 콜백함수에 의해 돌아가는데, 주위 디바이스들을 스캔해오는 핵심적인 메소드이다.
     * 그 안에 스레드가 돌면 쭉 비콘 기기들을 담아서 리스트에 보관 할 수 있게 구현 가능하다
     */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SingleList.getInstance();
        SingleQueue.getInstance();
        SingleRssiQueue.getInstance();
        SchSingleList.getInstance();
    ...
    private BluetoothAdapter.LeScanCallback mLeScanCallback =
            new BluetoothAdapter.LeScanCallback() {
                ...
                public void onLeScan(final BluetoothDevice device, int rssi, byte[] scanRecord) {
                    ...
                    thread = new ServiceThread(handler, device, rssi);
                    thread.start();
                }
            };
